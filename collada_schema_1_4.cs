...
//------------------------------------------------------------------------------
//
// Correction to joints node by cmar
...
//    [DebuggerStepThrough]
    ...
    public class technique
    {
        ...
        // layer, roll, tip fields added by cmar for Blender compatibility
    ...
    public partial class COLLADA
    {
        ...
        {
            FileStream stream = new FileStream(fileName, FileMode.Open, FileAccess.Read);       //cgm - to handle read-only files
            COLLADA result;
            try
            {
                result = Load(stream);
